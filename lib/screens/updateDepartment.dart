...
class _AddDepartmentState extends State<UpdateDepartment> {
  ...
  Widget build(BuildContext context) {
    final UpdateDepartment args = ModalRoute.of(context).settings.arguments;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          if (isGenerate == true) {
            postViewModel.updateDepartment(ownerName.text, phoneNumber.text, numRooms.text, address.text, area.text, price.text, westSide.text, northSide.text, eastSide.text, southSide.text,args.id);
