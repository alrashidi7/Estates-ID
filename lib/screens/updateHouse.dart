...
class _AddDepartmentState extends State<UpdateHouse> {
  ...
  Widget build(BuildContext context) {
    final UpdateHouse args = ModalRoute.of(context).settings.arguments;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          if (isGenerate == true) {
            postViewModel.updateHouse(ownerName.text, phoneNumber.text, numRooms.text, address.text, area.text, price.text, westSide.text, northSide.text, eastSide.text, southSide.text,args.id);
